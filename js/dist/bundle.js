...
angular.module('portfolioApp').service('DataService', function ($http) {
  'use strict';

  var xmlGetElement = function xmlGetElement(parent, name) {
    var out = '';
    var e = parent.getElementsByTagName(name)[0];
    if (e) {
      var c = e.childNodes[0];if (c) {
        out = c.nodeValue;
      }
    }
    return out;
...
angular.module('portfolioApp').controller('contactmeCtrl', function ($scope, $http) {
  'use strict';
...
angular.module('portfolioApp').controller('mainCtrl', function ($scope, $http, DataService) {
  'use strict';
...
angular.module('portfolioApp').controller('tabActivatedCtrl', function ($scope) {
  'use strict';
...
angular.module('portfolioApp').directive('slideshow', function () {
  'use strict';
...
!function () {
  function a(a) {
    var _b2,
        ...
        f = "DOMContentLoaded",
        g = (e ? /^loaded|^c/ : /^loaded|^i|^c/).test(d.readyState);g || d.addEventListener(f, _b2 = function b() {
      for (d.removeEventListener(f, _b2), g = 1; _b2 = c.shift();) {
        _b2();
      }
    ...
    function a(a) {
      ...
      if (a.a == m) {
        if (b == a) throw new TypeError();var c = !1;try {
          var d = b && b.then;if (null != b && "object" == (typeof b === 'undefined' ? 'undefined' : _typeof(b)) && "function" == typeof d) return void d.call(b, function (b) {
            c || f(a, b), c = !0;
          }, function (b) {
            c || g(a, b), c = !0;
          });
      ...
      return new c(function (b, c) {
        function d(c) {
          return function (d) {
            ...
            g = [];0 == a.length && b(g);for (var h = 0; h < a.length; h += 1) {
          e(a[h]).c(d(h), c);
        }
      });
    }function j(a) {
    ...
    function a(a) {
      this.el = a;for (var b = a.className.replace(/^\s+|\s+$/g, "").split(/\s+/), c = 0; c < b.length; c++) {
        d.call(this, b[c]);
      }
    }function b(a, b, c) {
      ...
      var c = Array.prototype,
          d = c.push,
          e = c.splice,
          f = c.join;a.prototype = { add: function add(a) {
  ...
  }();var g = { observe: function observe(a, b) {
      for (var c = b.prefix, d = function d(a) {
    ...
    }, loadAsync: function loadAsync(a) {
      e(a);
    } },
      i = { load: function load(a) {
    ...
    if (window.FontAwesomeCdnConfig) {
      var j = window.FontAwesomeCdnConfig,
          ...
          p = "ï‰€",
          q = d.bind(d, "fa"),
          r = function r() {};j.autoA11y.enabled && (a(q), c(q)), j.reporting.enabled && b(j.reporting.domains, location.host) && i.load(l + "/js/stats.js"), cssUrl = "https://" + k + "/" + m + ".css", new f(n).load(p).then(function () {
...
(function () {
  ...
  var addEvent = function addEvent(elem, eventName, eventHandler) {
  ...
  var onOverLeaveAddRemoveStyle = function onOverLeaveAddRemoveStyle(sourceElem, targetElem, classNameActive, classNameInactive, onInit, targetCallbackOver, targetCallbackLeave) {
    if (sourceElem == undefined || targetElem == undefined) return;
    ...
    var fromDomJS_isObjectHTMLElement = function fromDomJS_isObjectHTMLElement(object) {
      try {
    ...
    if (fromDomJS_isObjectHTMLElement(sourceElem)) return;

    if (fromDomJS_isObjectHTMLElement(targetElem)) return;

    (function () {
      if (onInit) onInit(targetElem);
      ...
      addEvent(sourceElem, "mouseover", function () {
        ...
        if (targetCallbackOver) targetCallbackOver(targetElem);
      });
      addEvent(sourceElem, "mouseleave", function () {
        ...
        targetElem.className = classes;
        if (targetCallbackLeave) targetCallbackLeave(targetElem);
      });
    })();
  };
...
var documentLoadScriptByURL = function documentLoadScriptByURL(url, callback) {
  /* USAGE:
